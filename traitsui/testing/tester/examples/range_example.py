""" Example for utilizing UI Tester on various modes of Range editor.

In this example, the Tester locates the textbox for the each style of Range
Editor and modifies the value.
"""
import platform
...
class RangeModel(HasTraits):
    """ Dummy class holding the Int trait to be displayed with a ListEditor.
    """
...
def get_view(mode):
    """ Gets a view with a specific mode """
    return View(
        Item(
            "value",
