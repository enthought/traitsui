""" This example showcases using the tester to interact with nested UIs.
Examples for various editors are wrapped in a Notebook List Editor. The
Tester navigates through these tabs and interacts with each of the
editors.
"""
import random
...
class CheckListExample(HasStrictTraits):
    """ CheckList Editor example class """
...
class Notebook(HasStrictTraits):
    """ Notebook class to wrap the other editor examples. """
...
# create the list of editor examples
editors_list = [
    ButtonExample(), TextboxExample(), RangeExample(),
