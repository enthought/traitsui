...
from traitsui.testing.api import command, InteractionRegistry, query, UITester
...
LOCAL_REGISTRY = InteractionRegistry()
if is_wx():
    from traitsui.wx.button_editor import CustomEditor, SimpleEditor
